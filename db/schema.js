...
CREATE TABLE resources_contributors (
  ...
  resource_id INT REFERENCES topics(topics_id),
  contributor_id INT REFERENCES users(users_id)
);
...
CREATE TABLE resources_topics (
  ...
  resource_id INT REFERENCES topics(topics_id),
  topic_id INT REFERENCES topics(topics_id)
);
...
INSERT INTO topics VALUES ("aaaTestTopic", "aTT");
